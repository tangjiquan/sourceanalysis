...
public class Stat implements Record {
  ...
  private long mzxid;//表示该节点最后一次被更新的事务ID
  private long ctime;//该节点被创建的时间
  private long mtime;//该节点最后一次被更新的时间
  ...
  private int numChildren;//当前节点的子节点的个数
  private long pzxid;//该节点的子节点列表最后一次被修改时的事务ID。注意，只有子节点的列表变更才会变更pzxid，
  					//字节点内容变更不会影响pzxid
  public Stat() {
  }
  public Stat(
